...
if __name__ == "__main__":
    #print(auto_vigenere(message, 2))
    print(mot_plus_long(message))
    plt.plot([mot_plus_long(auto_vigenere(message, i)) for i in range(1,10)]) #probabilité d'avoir une longueur de clé de ...
    plt.show()
